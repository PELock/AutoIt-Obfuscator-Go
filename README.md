# AutoIt Obfuscator — Obfuscation for AutoIt Script Source Code (Go module)
...
## Protect your AutoIt scripts source code (Go)
...
The module path is `github.com/PELock/AutoIt-Obfuscator-Go`.
